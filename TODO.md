...
- [x] Bundled as `collector_vision/weights/cornelius.onnx` (4.4 MB, single file)
...
- [x] Corner detector (Cornelius) — `cornelius.onnx` (4.4 MB, single file)
...
#### B1. ONNX models ✅
- [x] Cornelius exported to ONNX (`cornelius.onnx`, 4.4 MB) and verified
